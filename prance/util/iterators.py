...
def item_iterator(
    value: JsonValue, path: tuple[PathElement, ...] = ()
...
def reference_iterator(
    specs: JsonValue, path: tuple[PathElement, ...] = ()
) -> Iterator[tuple[PathElement, JsonValue, tuple[PathElement, ...]]]:
    """
